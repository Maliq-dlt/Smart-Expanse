    ...
    >
      ...
      <div className="flex items-center space-x-1">
        <button
          ...
          className="text-[var(--color-on-surface-variant)] hover:bg-[var(--color-surface-variant)]/50 focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] outline-none transition-colors rounded-full p-2 flex items-center justify-center"
